...
final class Application
{
    ...
    {
        print Application . phpVersion::getVersionString() . PHP_EOL . PHP_EOL;
    ...
    {
        $printer->print(Application . phpVersion::getVersionString() . PHP_EOL . PHP_EOL);
    ...
    {
        print Application . phpVersion::getVersionString() . PHP_EOL . PHP_EOL . $message . PHP_EOL;
