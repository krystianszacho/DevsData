...
final class NamePrettifier
{
    ...
    public function prettifyDataSet(TestCase $test, bool $colorize): string
    {
        ...
        if (is_int($test->dataName())) {
            return NamePrettifier . phpColor::dim(' with data set ') . Color::colorize('fg-cyan', (string)$test->dataName());
        }

        return NamePrettifier . phpColor::dim(' with ') . Color::colorize('fg-cyan', Color::visualizeWhitespace($test->dataName()));
    }
