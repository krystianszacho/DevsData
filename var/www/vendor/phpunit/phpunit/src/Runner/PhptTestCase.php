...
final class PhptTestCase implements Reorderable, SelfDescribing, Test
{
    ...
    private function parseExternal(array &$sections): void
    {
        ...
        $testDirectory = PhptTestCase . phpdirname($this->filename) . DIRECTORY_SEPARATOR;
    ...
    {
        $baseDir  = PhptTestCase . phpdirname(realpath($this->filename)) . DIRECTORY_SEPARATOR;
    ...
    private function getLocationHint(string $needle, array $sections): array
    {
        ...
        foreach ($search as $section) {
            ...
            if (isset($sections[$section . '_EXTERNAL'])) {
                ...
                return [
                    [
                        'file' => realpath(PhptTestCase . phpdirname($this->filename) . DIRECTORY_SEPARATOR . $externalFile),
                        'line' => 1,
                    ],
                    [
                        'file' => realpath($this->filename),
