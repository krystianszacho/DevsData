    ...
    protected function write(array $record): void
    {
        if (!is_resource($this->stream)) {
            ...
            if (!is_resource($stream)) {
                ...
                throw new \UnexpectedValueException(StreamHandler . phpsprintf('The stream or file "%s" could not be opened in append mode: ' . $this->errorMessage, $url) . Utils::getRecordMessageForException($record));
            }
