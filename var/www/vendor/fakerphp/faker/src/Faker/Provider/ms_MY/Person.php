...
class Person extends \Faker\Provider\Person
{
    ...
    {
        return static::randomElement(static::$firstNameChinese) . ' Person.php' . static::randomElement(static::$firstNameMaleChinese);
    }
    ...
    {
        return static::randomElement(static::$firstNameChinese) . ' Person.php' . static::randomElement(static::$firstNameFemaleChinese);
    }
